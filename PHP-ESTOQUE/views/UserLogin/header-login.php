...
<header>
    <nav>
        <ul class="nav-ul">
            <li class="nav-li nav-menu-lateral" style="display: none;">
                <div class="nav-li-div nav-menu-lateral-div">
                    <button class="nav-menu-lateral-botao button" onclick="switchModal()">
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 448 512"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M0 96C0 78.3 14.3 64 32 64l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 128C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 288c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32L32 448c-17.7 0-32-14.3-32-32s14.3-32 32-32l384 0c17.7 0 32 14.3 32 32z"/></svg>
                    </button>
                </div>
            </li>
            ...
            <li class="nav-li nav-pesquisador">
                <div class="nav-li-div pesquisador-div" style="display: none;">
                    <input type="search" id="pesquisa" name="nome_produto" placeholder=""/>
                    <button type="submit" class="pesquisador-login button" onclick="pesquisar()">
            ...
            <li class="nav-li" id="nav-signup" style="margin-right: 10vw;">
                <div class="nav-li-div" id="signup-div">
                    <?php if ($_SERVER['PATH_INFO'] !== '/signup'): ?>
                        <a href="/signup" class="nav-signup-botao">
                            <button class="login-botao button">
                                SIGNUP
                            </button>
                        </a>
                    <?php elseif ($_SERVER['PATH_INFO'] === '/signup'): ?>
                        <a href="/login" class="nav-signup-botao">
                            <button class="login-botao button">
                                LOGIN
                            </button>
                        </a>
