...
<section class="section-add-produto">
    <a class="section-a" id="add-produto" href="/cadastro">
    ...
    <main class="main-product-list">
        ...
        <div class="lista-estoque">
            <ul class="lista-estoque-ul">
                <li class="lista-estoque-li" id="li-cabecalho">
                    <div class="lista-estoque-div cabecalho">
                        <span class="coluna" id="coluna-produto"><strong>Produto</strong></span>
                        <span class="coluna" id="coluna-qtd"><strong>Quantidade</strong></span>
                        <span class="coluna" id="coluna-preco"><strong>Preço</strong></span>
                        <span class="coluna" id="coluna-subcategoria"><strong>Subcategoria</strong></span>
                        <span class="coluna" id="coluna-categoria"><strong>Categoria</strong></span>
                        <span class="coluna" id="coluna-empty"><strong>Info</strong></span>
                        <span class="coluna" id="coluna-botao"><strong>Editar</strong></span>
                        <span class="coluna" id="coluna-botao"><strong>Excluir</strong></span>
                    </div>
                </li>
                <?php foreach ($products as $key => $product): ?>
                <li class="lista-estoque-li">
                    <div class="lista-estoque-div produtos">
                        <span class="coluna" id="coluna-produto"><?= $product->getNameProduct() ?></span>
                        <span class="coluna" id="coluna-qtd"><?= $product->getQuantity() ?></span>
                        <span class="coluna" id="coluna-preco"">R$ <?= $product->getPrice() ?></span>
                        <span class="coluna" id="coluna-subcategoria"><?= $product->getNameSubcategory() ?></span>
                        <span class="coluna" id="coluna-categoria"><?= $product->getNameCategory() ?></span>
                        <span class="coluna" id="coluna-empty">
                            <button type="button" id="view-product" onclick="showModal()">
                        ...
                        <span class="coluna" id="coluna-botao">
                            <a href="./edicao?id=<?= $product->getId() ?>">
                        ...
                        <span class="coluna" id="coluna-botao">
                            <a href="./exclusao?id=<?= $product->getId() ?>">
